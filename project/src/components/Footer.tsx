      ...
      <div className="max-w-7xl mx-auto px-4 pt-14 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <span className="font-extrabold text-2xl tracking-wider block">GARDECO</span>
                <span className="text-green-400 text-[10px] tracking-widest uppercase">Grow Your Dreams</span>
              </div>
            </div>
            ...
            <div className="space-y-2.5 text-sm text-green-200">
              ...
              <div className="flex items-center gap-3">
                ...
                <span>info@gardeco.in</span>
              </div>
              <div className="flex items-start gap-3">
                <MapPin size={15} className="text-green-400 flex-shrink-0 mt-0.5" />
                <span>123 Green Park, Hyderabad, Telangana - 500001</span>
              </div>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-[#1a6b00] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-green-300 text-sm text-center md:text-left">
            © 2024 Gardeco. All rights reserved. Made with love for Indian gardeners.
          </p>
