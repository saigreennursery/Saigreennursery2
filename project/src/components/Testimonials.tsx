...
const testimonials = [
  {
    ...
    location: 'Delhi',
    rating: 5,
    text: 'I have been using GARDECO grow bags for two seasons now. My tomatoes and chillies have never been healthier! The drainage is excellent and the bags are very durable.',
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 mt-3 max-w-xl mx-auto">
            Join thousands of happy gardeners who trust GARDECO for their growing needs
          </p>
        </div>
