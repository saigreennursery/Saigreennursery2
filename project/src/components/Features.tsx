    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <span className="text-[#1a6b00] text-sm font-bold tracking-widest uppercase">Why GARDECO</span>
        ...
        <div className="mt-20 bg-[#f7fdf4] rounded-3xl p-10 border border-[#d4edcc]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { step: '04', title: 'Watch it Grow', desc: 'Enjoy lush, healthy plants growing in your GARDECO bags!' },
            ].map((item) => (
